...
echo "======================================"
echo "  API:       http://localhost:5055 (via Traefik externamente em demo.connectaiacare.com)"
echo "  Frontend:  http://localhost:3030 (via Traefik em app.connectaiacare.com)"
echo ""
echo "  Próximos passos:"
echo "    1. Apontar DNS connectaiacare.com → IP da VPS"
echo "    2. Repointar webhook V6 no Evolution:"
echo "       curl -X PUT \$EVOLUTION_URL/webhook/set/v6 \\"
echo "         -H 'apikey: \$EVOLUTION_KEY' \\"
echo "         -d '{\"url\": \"https://demo.connectaiacare.com/webhook/whatsapp\"}'"
echo "    3. Teste end-to-end: enviar áudio pelo WhatsApp para 555189592617"
echo "======================================"
